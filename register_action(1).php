...
try {
    ...
    $notification_message = "New teacher registered: " . htmlspecialchars($name);
    $notification_link = "manage_teachers.php";
    notify_admins($pdo, $notification_message, $notification_link);
