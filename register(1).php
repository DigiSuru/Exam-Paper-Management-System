...
<body class="h-full">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <h2 class="mt-6 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Create a new teacher account</h2>
        </div>
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="bg-white px-6 py-8 shadow sm:rounded-lg sm:px-10">
                <form class="space-y-6" action="register_action(1).php" method="POST">
                    <div>
            ...
            <p class="mt-8 text-center text-sm text-gray-500">
                ...
                <a href="index.php" class="font-semibold leading-6 text-blue-600 hover:text-blue-500">Sign in here</a>
            </p>
        </div>
    </div>
</body>
